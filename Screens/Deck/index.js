      ...
      <View style={container}>
        ...
        <View style={{ marginTop: 80, width: 300 }}>
          <TouchableOpacity onPress={() => navigation.navigate('AddCard', { deck })}>
            <Text style={[styles.button, { borderColor: blue, color: blue }]}>Adicionar um cartão</Text>
          </TouchableOpacity>

          <TouchableOpacity 
            onPress={
              () => (deck.questions.length === 0 ? alert('Adicione um cartão primeiro') : navigation.navigate('Quiz', { deck }))
            }
          >
